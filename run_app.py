...
credit_card_df, summary = load_data_and_summary() # Load the dataset + numeric summary


app.layout = create_dashboard_layout( # Register the layout
...
register_callbacks( # Register callbacks with data
    credit_card_df,
    summary['amount_min'],
    summary['amount_max'],
